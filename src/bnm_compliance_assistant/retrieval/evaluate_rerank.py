...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate reranked retrieval against smoke cases.")
    ...
    print(f"Reranked retrieval smoke evaluation: {report['top_k_hits']}/{report['total']} top-{args.top_k}")
