...
from bnm_compliance_assistant.retrieval.hybrid import HybridRetriever


def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate hybrid retrieval against smoke cases.")
    ...
    print(f"Hybrid retrieval smoke evaluation: {report['top_k_hits']}/{report['total']} top-{args.top_k}")
